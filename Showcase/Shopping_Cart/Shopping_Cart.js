...
function checkout() {
    ...
    document.getElementById("total").innerHTML = "You have spent a total amount of: R" + totalOrderAmt.toFixed(2);
    alert("You have spent a total amount of: R" + totalOrderAmt.toFixed(2));
}
